...
Results:
Running ./mm_blind 2000 from the command line takes roughly 1.5 minutes,
while ./mm_aware 2000 50 takes only about 45 seconds.
On a 2015 MacBook Pro with i5-5257U processor, we can use the XCode
tool Instruments to profile the MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_MISS 
count of the processor.
Running ./mm_blind 1000 in Instruments with this counter takes about 15
seconds and counts about 1.8 million L3 cache misses (profile_blind_1000.pdf).
Running ./mm_aware 1000 40, on the other hand, takes just 6 seconds and
counts only around 70,000 L3 misses (profile_aware_1000_40.pdf).
*/
